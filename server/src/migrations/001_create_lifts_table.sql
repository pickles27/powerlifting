-- Create lifts table for powerlifting data
...
-- Create composite indexes for leaderboard queries
...
COMMENT ON TABLE lifts IS 'Powerlifting competition results from OpenPowerlifting dataset';
COMMENT ON COLUMN lifts.source_hash IS 'Unique hash for deduplication based on lifter, meet, and performance';
